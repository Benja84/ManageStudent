    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('members.update',$member->id) }}" method="POST" enctype="multipart/form-data" id="action_save">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group mb-4">
                            <div class="w-1/4 flex mb-3">
                                ...
                                <div class="flex space-x-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="gender" value="M" class="form-radio" @if($member->user->gender == "M") checked @endif>
                                        <span class="ml-2 text-gray-700">Masculin</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="gender" value="F" class="form-radio" @if($member->user->gender == "F") checked @endif>
                            ...
                            <div class="w-4/4">
                                <div class="space-y-4">
                                    ...
                                    <input id="lastname" name="lastname" type="text" class="w-full p-2 border rounded form-control" value="{{ old('lastname',$member->user->lastname) }}" required>

                                    <label for="firstname">Prénom <span class="text-warning">*</span></label>
                                    <input id="firstname" name="firstname" type="text" class="w-full p-2 border rounded form-control " value="{{ old('firstname',$member->user->firstname) }}" required>

                                    <label for="email">Email <span class="text-warning">*</span></label>
                                    <input id="email" name="email" type="email" class="w-full p-2 border rounded form-control" value="{{ old('email',$member->user->email) }}" required>

                                    <label for="phone">Téléphone <span class="text-warning">*</span></label>
                                    <input id="phone" name="phone" type="text" class="w-full p-2 border rounded form-control" value="{{ old('phone',$member->user->phone) }}" required>
                                    ...
                                    <div>
                                        ...
                                        <select name="role" class="form-select selectpicker" placeholder="Selectionner les groupes" title="Sélectionner les groupes">
                                            ...
                                            @foreach($roles as $key => $role)
                                                <option value="{{ $key }}" @if($member->user->role() == $role) selected @endif>{{ $role }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex space-x-4">
                                <div class="w-1/3">
                                    ...
                                    <input type="date" name="birthdate" value="{{ old('birthdate',$member->user->birthdate) }}" class="w-full p-2 border rounded form-control">
                                </div>
                                <div class="w-1/3">
                                    <label class="block text-gray-700">Lieu de naissance <span class="text-warning">*</span></label>
                                    <input type="text" name="birthplace_city" value="{{ old('birthplace_city',$member->user->birthplace_city) }}" class="w-full p-2 border rounded form-control">
                                </div>
                                <div class="w-1/3">
                                    ...
                                    <select name="nationality" class="w-full p-2 border rounded form-select">
                                        <option value="France" @if($member->user->nationality == "France") selected @endif>Francaise</option>
                                        <option value="Malagasy" @if($member->user->nationality == "Malagasy") selected @endif>Malagasy</option>
                                    </select>
                                </div>
                            </div>
                            <div class="flex space-x-4">
                                <div class="w-1/3">
                                    ...
                                    <input type="text" name="address_street" value="{{ old('address_street',$member->user->address_street) }}" class="w-full p-2 border rounded form-control">
                                </div>
                                <div class="w-1/3">
                                    <label class="block text-gray-700">Ville <span class="text-warning">*</span></label>
                                    <input type="text" name="address_city" value="{{ old('address_city',$member->user->address_city)}}" class="w-full p-2 border rounded form-control">
                                </div>
                                <div class="w-1/3">
                                    <label class="block text-gray-700">Code postal <span class="text-warning">*</span></label>
                                    <input type="text" name="address_postcode" value="{{ old('address_postcode',$member->user->address_postcode)}}" class="w-full p-2 border rounded form-control">
                                </div>
                                <div class="w-1/3">
                                    ...
                                    <select name="country" class="w-full p-2 border rounded form-select">
                                        <option value="France" @if($member->user->address_city == "France") selected @endif>France</option>
                                        <option value="Madagascar" @if($member->user->address_city == "Madagascar") selected @endif>Madagascar</option>
                                    </select>
                                </div>
                            </div>
                        </div>
